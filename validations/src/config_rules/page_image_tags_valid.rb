...
module Src
  module ConfigRules
    class PageImageTagsValid < Src::ConfigRules::Base
      attr_reader :page_file, :course_base_directory_name, :chapter_base_directory_name, :images_path

      def initialize(page_file, course_base_directory_name, chapter_base_directory_name, images_path)
        @page_file = page_file
